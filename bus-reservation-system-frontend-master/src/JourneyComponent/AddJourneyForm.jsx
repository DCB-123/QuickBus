...
const AddJourneyForm = () => {
  ...
  const retrieveAllBuss = async () => {
    const response = await axios.get(
      "http://localhost:8004/api/bus/fetch/all",
      {
        headers: {
  ...
  const retrieveAllBusStop = async () => {
    const response = await axios.get(
      "http://localhost:8004/api/busStop/fetch/all"
    );
    console.log(response.data);
    return response.data;
  };
  ...
  const retrieveAllJourneyStatus = async () => {
    const response = await axios.get(
      "http://localhost:8004/api/journey/status/all",
      {
        headers: {
          Authorization: "Bearer " + admin_token, // Replace with your actual JWT token
        },
  ...
  const saveJourney = (e) => {
    ...
    fetch("http://localhost:8004/api/journey/add", {
      method: "POST",
      headers: {
