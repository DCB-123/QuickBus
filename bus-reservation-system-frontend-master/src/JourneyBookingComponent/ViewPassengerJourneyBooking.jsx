...
const ViewPassengerJourneyBooking = () => {
  ...
  const retrieveAllBookedJourneys = async () => {
    const response = await axios.get(
      "http://localhost:8004/api/journey/book/fetch/user?userId=" +
        passenger.id,
      {
        headers: {
  ...
  const cancelJourneyTicket = (bookingId) => {
    fetch(
      "http://localhost:8004/api/journey/book/ticket/cancel?bookingId=" +
        bookingId,
      {
        method: "DELETE",
        headers: {
  ...
  const downloadTicket = (bookingId) => {
    fetch(
      `http://localhost:8004/api/journey/book/download/ticket?bookingId=${bookingId}`,
      {
        method: "GET",
        headers: {
          Authorization: "Bearer " + passenger_token,
